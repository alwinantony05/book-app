...
const firebaseConfig = {
    apiKey: "AIzaSyAezq7MgMfEa-INdX-3C9CUaKz2u_-T5o0",
    authDomain: "budgetplanner-88404.firebaseapp.com",
    projectId: "budgetplanner-88404",
    storageBucket: "budgetplanner-88404.firebasestorage.app",
    messagingSenderId: "315102352172",
    appId: "1:315102352172:web:2e625bfe5b078c566dd289",
    measurementId: "G-0RJ7NYRGL8"
  };
...
//BOT MESSAGE, AFTER OPENING CHATBOT
...
function addChatMessage(sender, text) {
  ...
  img.src = (sender === 'Bot') ? 'bot.jpg' : 'user.jpg';
...
// Open chat & show welcome message
chatIcon.addEventListener("click", function() {
  chatWindowContainer.style.display = "flex"; 
  // Add a welcome message if it's the first time opening
  if (!chatWindowContainer.dataset.opened) {
    addChatMessage("Bot", "Welcome to the Book Chat! How can I help you today?");
    chatWindowContainer.dataset.opened = true; // Mark as opened
  }
});
